                                  ...
                                  <div className="p-explore_moreContent">
                                    {reg.map((cate, i) => (
                                      <TabButton
                                        ...
                                        modifiers="category"
                                        handleClick={() =>
                                          handleFilter("category", cate.name)
                                        }
                                      >
                              ...
                              list={
                                res === "Trend"
                                  ? store?.productsTrend.map((item) => ({
                                      ...
                                      creator_acc:
                                        item.collectible.creator_acc?.avatar
                                          .String,
                                      categories: item.collectible.categories,
                                      instant_sale_price:
                                        item.collectible.instant_sale_price,
                                      token_owner: item.collectible.token_owner,
                                      creator_address:
                                        item.collectible.creator_acc?.address,
                                      userName:
                                        item.collectible.creator_acc?.username
                                          .String,
                                      token_id: item.collectible.token_id,
                                      description: item.collectible.description,
                                      status: item.collectible.status,
                                      quote_token:
                                        item.collectible.quote_token.name,
                                      unlock_once_purchased:
                                        item.collectible.unlock_once_purchased,
                                      src: item.collectible.upload_file,
                                      ownerAvatar:
                                        item.collectible.owner?.avatar.String,
                                  ...
                                  : store?.products.map((item) => ({
                                      ...
                                      unlock_once_purchased:
                                        item.unlock_once_purchased,
                                      creator_acc:
                                        item.creator_acc?.avatar.String,
                                      creator_address:
                                        item.creator_acc?.address,
                                      userName:
                                        item.creator_acc?.username.String,
